					...
					case 3: // Удалить запись
						{
							...
							do 
							{
								...
								{
									Log newDelete;
									newDelete.title = Table[choiceNumberDelete - 1].naz;
					...
					case 4: // Обновить запись
						{
							...
							do 
							{
								...
								{
									string oldnaz = Table[choiceNumberChange - 1].naz;
									...
									int oldPlosh = Table[choiceNumberChange - 1].plosh;
									...
									int oldUrozh = Table[choiceNumberChange - 1].urozh;
